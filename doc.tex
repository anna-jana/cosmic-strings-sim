...
Here the nabal is with respect to comoving coordinates. They are related to physical (distances) coordinates by $x_\mathrm{physical} = a(t) x_\mathrm{comoving}$.
